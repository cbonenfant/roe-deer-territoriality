...
energetically sustainable \citep{Emlen1977}. Territory marking in male
...
1996). Recent theoretical models linking territorial behaviour and
animal movements predict a central place forager type of movements
...
\krisin{Ces papiers suggèrent que l'on devrait regarder le NSD, je
  dirais par rapport au point central de toutes les obs. On peut y
  jeter un oeil?}

\subsection*{Rut}

\subsection*{Male--female comparison}
