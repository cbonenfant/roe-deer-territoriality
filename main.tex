...
respectively.\nico{On n'a pas le même nombre d'individus à l'issu du
  clustering}\kris{Oui mais du coup on fait quoi ? Je ne sais pas trop
  d'où ça vient. C'est Vincent qui a éliminé certains individus?} We
performed our model selection with the second order Akaike’s
...
peak shortly after the birth period, whereas it was more or less
constant for males. These temporal fluctuations were generally more
pronounced for adults compared to yearlings and sub-adults
(Fig.~\ref{}).
...
\krisin{Je pense qu'il faudrait davantage préciser les dates de pics
  et minima que l'on peut visualier sur les GAMs. Apparemment il y a
  une fonction qui fait ça dans GAM, on pourrait essayer. C'est bien
  de dire que le pic tombe dans la période attendue, mais encore mieux
  de pouvoir dire à quelle date exacte se situe le pic dans l'année.}
