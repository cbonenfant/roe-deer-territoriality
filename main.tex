...
Because it is quite hard to characterize specifically on marked
...
territoriality and rut of males. Because mainly adult males should
engaged into reproduction, we instead attempted to quantify the
...
mostly adults. We assumed that a high proportion of individuals of the
same sex belong to the same group would be a sign of good discriminant
power and ability to infer a male's mating behaviour from movement and
activity. Below we detail the analyses at the population and individual
levels.
...
3.3.1 (R Core Team, 2016).\nico{penses-tu qu'il soit nécessaire
  d'expliquer que nous avons augmenter le lissage}\kris{Je pense que
  oui, en plus j'ai l'impression que c'est pas bien connu cette
  histoire...}  Finally, because the inclusion of non-sedentary
animals might influence our results we eliminated all individuals that
