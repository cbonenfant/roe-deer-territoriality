...
behaviour in the wild of most small felids (Mellen 1993), as for example the jaguar \species{Panthera onca} (Leuchtenberger et al. 2009) or ocelot  \species{Leopardus pardalis} (Brown 2011), or several other mammals like for example aardvark \species{Orycteropus afer}, pangolins, tapirs \species{Tapirus spp.}, hippopotamuses, perccaries, viverids, because of the observation limitation imposed
by the species lifestyle and its habitat preferences (Wilson et al. 2009). In this context, indirect measures, like display of agonistic interactions monitored by
...
(Thiebault and Tremblay 2013; Browning et al. 2018; Carter et al. 2016). Denning dates were derived from the first date with no-movement of
black bears (\nico{ref}). Assuming that a behaviour is associated to a change in
...
Age is another important structuring variable of mating behaviour in large herbivores because young males may not be physiologically mature yet or may be prevented to access to reproduction by older males (Clutton-Brock 1992). In roe deer, territory marking should be less frequent for yearlings but much more common for males 2yrs and older (Johansson and Liberg 1996). Our results only partially support this assertion. Assuming that the activity level of individuals increases with marking and rubbing, we found almost no evidence of territoriality from activity records for male roe deer younger than 3 at Aurignac (Fig.~\ref{fig:age}) \nico{ceci dit au niveau individuel on retient le modèle sexe x age donc on a l même patron sur les 2 sites, même si c'est moins évident au niveau populationnel}. In contrast the peak of activity increased more gradually from yearlings to adults in the Bavarian Forest population. In agro-system like Aurignac, young males may not engage into reproduction because ??? (Hewison)\nico{peut-être plus forte densité de chevreuils donc plus forte compétition mâle-mâle pour l'accès aux territoires - on a également une proportion élevée de dispersion natale, donc les jeunes ils sont peut-être engagés dans d'autres priorités que celle de définir un territoire}. Some technical issues could also explain the marked difference in activity between sites because collar brand was different at AUR and BAV and on-board activity loggers may not record activity exactly in the same way. However, even if the absolute values cannot be compared between the two sites, we have defined maximums in activity at both sites and we believe that we were able to capture relative variation in activity between those sites.
...
In roe deer, rutting males chase away any competitor and actively search for females. They also maintain territory marking with rubbing and scrapping. 

In sharp contrast with territoriality, the timing of rut seems rather constrained temporally. Peaks of activity of males occurred on July 29th during rut in France and Germany, while it was observed one month earlier in France during territoriality (April 11th vs. May 16th). Unlike territoriality which may depend on the internal state of males, the timing of rut is more likely to be triggered by the presence of ovulating females. At the population level, female roe deer are relatively synchronous in parturition dates with 80\% of births in a 3-weeks time window (Plard et al. 2013). Assuming a low heterogeneity in gestation length among females, ovulation dates are likely to be as synchronous which is consistent with the limited duration of rut we observe (~ 30 days, see Fig.\ref{fig:sex}). More importantly, the average parturition date is strikingly similar across years because the main environmental cue used by females to start reproducing is day length (Plard et al. 2014). As a result females may ovulate at the same time across populations, and so is the rut of males. We hence expect the timing of rut to be much less variable in time and space for roe deer than for other large herbivores like the red deer (\textit{e.g.} Bonenfant et al. 2004).
\krisin{Je me demande si ce ne serait pas mieux de traiter l'effet site pour la territorialité et le rut en même temps, puis les effets d'âge de la même manière. Une préférence?} \nico{C'est vrai que cela aurait aussi du sens, mais d'un autre côté il me semble que cette distinction territorialité et rut est plus en adéquation avec le titre et l'objectif du papier.}
...
than movement data \nico{tu penses qu'il faut développer cette idée?}. Our results hence open the way to the detailed study of reproductive behaviour of male roe deer at the individual level and, for instance, to test for the effect of body mass, antler size or habitat quality on the timing and duration of territoriality and rut in roe deer\nico{on pourrait peut-être évoquer la question de comment cela est susceptible de jouer sur la "male's mating sucess", notamment on pourrait tester plusieurs des hypothèses proposées par Wahlström 2013 sur la défense du territorie comme un ornement sexuel}. Possibly the method could apply to other males of forest-dwelling species like the red or fallow deer \species{dama dama} for which reproductive behaviour is expected to affect their movement and activity (ref).
